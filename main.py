...
from utils.config import OPENLIBRARY_SEARCH_URL, SEARCH_QUERY, FETCH_LIMIT, YEAR_CUTOFF, OUTPUT_CSV_PATH
...
def main():
    ...
    raw_books = fetch_books(OPENLIBRARY_SEARCH_URL, SEARCH_QUERY, FETCH_LIMIT)
